...
def init_app():
    st.set_page_config(page_title="Holy Bible", page_icon=":books:", layout="wide")
    st.title('Holy Bible Bot')
    st.subheader("Champs d'expertise: La bible chrétienne, ....")
...
The Question is their query on an scientific articles, personnal notes.
...
User: I'd like to know who is PRJB
